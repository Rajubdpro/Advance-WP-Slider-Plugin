...
class Awp_Slider_Frontend
{
      ...
      <div class="hero-full owl-carousel owl-theme mt-5 " data-items="2">
                ...
                if ( $awp_slider_query->have_posts() ) {
                    while ( $awp_slider_query->have_posts() ) {
                        ...
                        <!----------- Single ----------->
                        <div class="awp-slider-item" style="background-image:url(<?php echo get_the_post_thumbnail_url(get_the_ID(), 'full'); ?>" alt="<?php the_title(); ?>); width: 100%;">
                                        ...
                                        <div class="awp-slider-caption">
                                            ...
                                            <div class="awp-slider-btn">
                                                <button class="default-btn-one btn slider-button">
                                                    <a href="<?php echo get_post_meta(get_the_ID(), 'slider_button_link', true); ?>"> <span class="circle" aria-hidden="true">
    ...
    function awp_slider_theme_color_cus( $wp_customize ) {
        ...
        $wp_customize->add_setting('awp_slider_defult_button_width', array(
            'defult' => '200px',
        ));
        //Add Button size setting
        $wp_customize->add_control('awp_slider_defult_button_width', array(
        ...
        $wp_customize->add_setting('awp_slider_defult_button_icon_color', array(
            'defult' => '#000000',
        ));
        //Add Button hover color setting
        $wp_customize->add_control('awp_slider_defult_button_icon_color', array(
    ...
    function awp_theme_color_cus() {
        ...
        <style>
            :root {
                ...
                --slider-navigator-hover-color: <?php echo esc_attr(get_theme_mod('awp_slider_navigator_hover_color')); ?>;
                ...
                --slider-button-icon-color: <?php echo esc_attr( get_theme_mod('awp_slider_defult_button_icon_color')); ?>;
                ...
                --slider-button-width: <?php echo esc_attr( get_theme_mod('awp_slider_defult_button_width')); ?>;
            }
        </style>
